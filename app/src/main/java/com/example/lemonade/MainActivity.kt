...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                displayTextView.text = getString(R.string.lemon_select)
                lemonImage!!.setImageResource(R.drawable.lemon_tree)
            }
            SQUEEZE -> {
                displayTextView.text = getString(R.string.lemon_squeeze)
                lemonImage!!.setImageResource(R.drawable.lemon_squeeze)
            }
            DRINK -> {
                displayTextView.text = getString(R.string.lemon_drink)
                lemonImage!!.setImageResource(R.drawable.lemon_drink)
            }
            RESTART -> {
                displayTextView.text = getString(R.string.lemon_empty_glass)
